...
var _AbstractEvent = __webpack_require__(155);
...
var _AbstractPlugin = __webpack_require__(160);
...
var _closest = __webpack_require__(203);
...
var _requestNextAnimationFrame = __webpack_require__(205);
...
var _Sensor = __webpack_require__(161);
...
var _SensorEvent = __webpack_require__(207);
...
var _DragEvent = __webpack_require__(105);
...
var _DraggableEvent = __webpack_require__(106);
...
var _Sensors = __webpack_require__(61);
...
var _Draggable = __webpack_require__(238);
...
var _Sensor = __webpack_require__(40);
...
var _MouseSensor = __webpack_require__(178);
...
var _TouchSensor = __webpack_require__(208);
...
var _DragSensor = __webpack_require__(210);
...
var _ForceTouchSensor = __webpack_require__(212);
...
var _SensorEvent = __webpack_require__(42);
...
var _getPrototypeOf = __webpack_require__(244);
...
module.exports = !__webpack_require__(16) && !__webpack_require__(32)(function () {
...
module.exports = !__webpack_require__(22) && !__webpack_require__(38)(function () {
...
var _CollidableEvent = __webpack_require__(216);
...
var _SnappableEvent = __webpack_require__(221);
...
var _DragEvent = __webpack_require__(225);
...
var _DraggableEvent = __webpack_require__(226);
...
var _Announcement = __webpack_require__(227);
...
var _Focusable = __webpack_require__(229);
...
var _Mirror = __webpack_require__(231);
...
var _Scrollable = __webpack_require__(236);
...
var _DroppableEvent = __webpack_require__(242);
...
var _SwappableEvent = __webpack_require__(251);
...
var _SortableEvent = __webpack_require__(254);
...
var _Plugins = __webpack_require__(214);

var Plugins = _interopRequireWildcard(_Plugins);

var _Draggable = __webpack_require__(50);

var _Draggable2 = _interopRequireDefault(_Draggable);

var _Droppable = __webpack_require__(241);

var _Droppable2 = _interopRequireDefault(_Droppable);

var _Swappable = __webpack_require__(250);

var _Swappable2 = _interopRequireDefault(_Swappable);

var _Sortable = __webpack_require__(253);
...
var _MouseSensor = __webpack_require__(179);
...
var _Sensor2 = __webpack_require__(40);
  ...
  (0, _createClass3.default)(MouseSensor, [{
    ...
    value: function value(event) {
      ...
      this.mouseDownTimeout = setTimeout(function () {
        ...
        if (_this2.dragging) {
          window.addYoloCustomEventListener('contextmenu', _this2[onContextMenuWhileDragging]);
          window.addYoloCustomEventListener('mousemove', _this2[onMouseMove]);
        }
      }, this.options.delay);
    }
...
var step = __webpack_require__(185);
var Iterators = __webpack_require__(41);
var toIObject = __webpack_require__(24);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(59)(Function.call, __webpack_require__(75).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _closest = __webpack_require__(204);
...
var _requestNextAnimationFrame = __webpack_require__(206);
...
var _AbstractEvent2 = __webpack_require__(8);
...
var _TouchSensor = __webpack_require__(209);
...
var _DragSensor = __webpack_require__(211);
...
var _ForceTouchSensor = __webpack_require__(213);
...
var _Collidable = __webpack_require__(215);
...
var _ResizeMirror = __webpack_require__(218);
...
var _Snappable = __webpack_require__(220);
...
var _SwapAnimation = __webpack_require__(223);
...
var _CollidableEvent = __webpack_require__(103);
...
var _Collidable = __webpack_require__(217);
...
var _ResizeMirror = __webpack_require__(219);
...
var _SnappableEvent = __webpack_require__(104);
...
var _Snappable = __webpack_require__(222);
...
var _SwapAnimation = __webpack_require__(224);
...
var _Announcement = __webpack_require__(228);
...
var _Focusable = __webpack_require__(230);
...
var _Mirror = __webpack_require__(232);
...
var _MirrorEvent = __webpack_require__(234);
...
function positionMirror() {
  ...
  return function (_ref9) {
    var mirror = _ref9.mirror,
        ...
        source = _ref9.source,
        args = (0, _objectWithoutProperties3.default)(_ref9, ['mirror', 'sensorEvent', 'mirrorOffset', 'initialY', 'initialX', 'scrollOffset', 'options', 'source']);
    ...
    return withPromise(function (resolve) {
      ...
      if (mirrorOffset) {
        ...
        if (options.makeParentContainingBlock) {
          var parent = source.parentElement;
          var transform = getComputedStyle(parent).getPropertyValue('transform');
          if (transform === 'none') {
            parent.style.transform = 'translate(0)'; // a dummy transform style to create a containing block
          }
          var boundingRect = parent.getBoundingClientRect();
          // make everything relative to parent now
          x -= boundingRect.left;
          y -= boundingRect.top;
        }
...
var _MirrorEvent = __webpack_require__(235);
...
var _Scrollable = __webpack_require__(237);
...
var _Emitter = __webpack_require__(240);
...
var _DroppableEvent = __webpack_require__(108);
...
var _Draggable2 = __webpack_require__(50);
...
var _SwappableEvent = __webpack_require__(110);
...
var _Swappable = __webpack_require__(252);
...
var _SortableEvent = __webpack_require__(111);
...
var _Sortable = __webpack_require__(255);
